...
@Component({
  ...
  standalone: true,
  imports: [WebsiteHeader, WebsiteNavigation, WebsiteFooter, PageSectionRenderer],
...
export class ConferenceTemplate {
  ...
  hasFeature(code: string): boolean {
    ...
    return this.data().features.some(
      (feature) => feature.featureCode.trim().toLowerCase() === normalizedCode && feature.isEnabled,
    );
  }
