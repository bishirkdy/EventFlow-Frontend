...
export const organizerRoutes: Routes = [
    {
        ...
        //         path: 'settings',
        //         loadComponent: () =>
        //             import('./pages/event-settings/event-settings')
        //                 .then(m => m.EventSettings),
        //     },
        ...
        //                 path: '',
        //                 loadComponent: () =>
        //                     import('./pages/venues/venues')
        //                         .then(m => m.Venues),
        //             },
        //             {
        //                 path: 'create',
        //                 loadComponent: () =>
        //                     import('./pages/venues/create-venue/create-venue')
        //                         .then(m => m.CreateVenue),
        //             },
        //             {
        //                 path: ':venueId',
        //                 loadComponent: () =>
        //                     import('./pages/venues/venue-details/venue-details')
        //                         .then(m => m.VenueDetails),
        //             },
        //         ],
        //     },
